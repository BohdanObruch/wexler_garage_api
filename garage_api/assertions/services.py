...
def assert_create_service_response(
    ...
    with allure.step("Check create service response fields"):
...
def assert_update_service_response(
    ...
    with allure.step("Check update service response fields"):
...
def assert_partial_update_service_response(
    ...
    with allure.step("Check partial update service response fields"):
